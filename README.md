...
A REST API built to help fetal clinics manage patient records and finances. It handles the full lifecycle of patient data — registration, search, categorization, health plan association — along with financial tracking of income and expenses.
